$(document).ready(function(){
	...
	var windowScroll = $(this).scrollTop();
		...
		if(window_width > 1000) {
			$('.bnr_info').addClass('animate-animbounceInUp');

			if($('.animatedparent').offset()){
				$('.animatedchild1').addClass('animate-animfadInLeft');
				$('.animatedchild2').addClass('animate-animFadeIn');
				$('.animatedchild3').addClass('animate-animfadInRight');
				console.log('gaguuuuu');
			}
		}
